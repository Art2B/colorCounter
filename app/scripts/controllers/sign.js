    ...
    function ($rootScope, $scope, $firebase) {
        ...
        $scope.signUp = function(user){
            ...
            if(user.password == user.passwordVerif){
                ...
                $scope.state = "The passwords don't match !";
            }
            console.log(newUser);
        }
        ...
        $scope.checkMail = function(mail){
            ...
            if(regFullMail.test(mail)){
                $scope.mailState = 'Probably the best email adress I\'ve seen so far';
            } else if(regWithAt.test(mail)){
                $scope.mailState = 'Wow, much better';
            } else if(mail != undefined) {
                $scope.mailState = 'Looks nice. Go on !';
            } else {
                $scope.mailState = '';
            }
        }
